  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          Nós, como membros, contribuidores e responsáveis por este projeto, comprometemo-nos a
          fazer da participação na nossa comunidade uma experiência livre de assédio para todos,
          independentemente da idade, tamanho corporal, deficiência visível ou não, etnia,
          características sexuais, identidade e expressão de género, nível de experiência,
          educação, condição socioeconómica, nacionalidade, aparência pessoal, raça, religião, ou
          identidade e orientação sexual.
        </p>
        <p className="mt-2.5">
          Comprometemo-nos a agir e interagir de formas que contribuam para uma comunidade
          aberta, acolhedora, diversa, inclusiva e saudável.
        </p>
      </section>

      <section>
        <h2>Os nossos padrões</h2>
        <p>Exemplos de comportamento que contribuem para um ambiente positivo:</p>
        <ul className="mt-2.5">
          <li>Demonstrar empatia e simpatia para com outras pessoas</li>
          <li>Respeitar opiniões, pontos de vista e experiências diferentes</li>
          <li>Dar e aceitar com elegância feedback construtivo</li>
          <li>
            Assumir responsabilidade e pedir desculpa a quem for afetado pelos nossos erros,
            aprendendo com a experiência
          </li>
          <li>Focar no que é melhor não só para nós individualmente, mas para a comunidade como um todo</li>
        </ul>
        ...
        <ul className="mt-2.5">
          ...
          <li>Trolling, comentários insultuosos ou depreciativos, e ataques pessoais ou políticos</li>
          <li>Assédio público ou privado</li>
          <li>Publicar informação privada de terceiros, como morada ou email, sem permissão explícita</li>
      ...
      <section>
        ...
        <p>
          O mantenedor do projeto é responsável por esclarecer e aplicar os nossos padrões de
      ...
      <section>
        <h2>Âmbito</h2>
        <p>
          Este Código de Conduta aplica-se a todos os espaços da comunidade (issues, pull
          requests, discussões neste repositório), e também quando alguém está a representar
      ...
      <section>
        ...
        <p>
          ...
          Todas as denúncias serão revistas e investigadas de forma pronta e justa. O mantenedor
      ...
      <section>
        ...
        <p className="mt-2.5">
          ...
          continuado, incluindo não interagir com as pessoas envolvidas durante um período
          determinado.
        </p>
        <p className="mt-2.5">
          <strong>3. Banimento temporário</strong> — Uma violação séria dos padrões da
          comunidade. Consequência: um banimento temporário de qualquer interação ou comunicação
          pública com a comunidade.
        </p>
        <p className="mt-2.5">
          <strong>4. Banimento permanente</strong> — Um padrão de violação, incluindo assédio a
          um indivíduo ou agressão a classes de pessoas. Consequência: um banimento permanente de
